...
document.addEventListener('DOMContentLoaded', function () {
  ...
  __WEBPACK_IMPORTED_MODULE_0_vue_dist_vue_esm__["a" /* default */].component('iss-info', {
    ...
    template: '\n      <div class="navbar">\n      <ul>\n          <li>{{info.timestamp}}</li>\n          <li>{{info.message}}</li>\n          <li>{{info.iss_position.latitude}}</li>\n          <li>{{info.iss_position.longitude}}</li>\n      </ul>\n        </div>\n     ',
    data: function data() {
      return {};
    },
...
/***/ })
/******/ ]);
//# sourceMappingURL=hello_vue-d46ba27ee9a9b9fe2f19.js.map